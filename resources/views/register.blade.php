                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mu-contact-form-area">
                                        ...
                                        <div id ="msgs" class="alert alert-success">{{ Session::get('message') }}</div>
                                        @endif
                                        @if(!empty(Session::get('msg')))
                                        <div id ="msgs" class="alert alert-danger">{{ Session::get('msg') }}</div>
                                        @endif
                                        <form action="{{url('/registeruser')}}" method="POST" id="registeruser" name="registeruser" class="mu-contact-form">
                                            @csrf
...
<!-- End main content -->
    ...
    <script>
        $(document).ready(function ()
        {
            ...
            $('#registeruser').validate({ // initialize the plugin
                rules: {
                    name:{
                        required:true
                    },
